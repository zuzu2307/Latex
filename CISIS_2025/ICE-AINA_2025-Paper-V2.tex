...
\begin{document}
\title*{A Fuzzy-based Handover System for 5G/B5G Wireless Networks Considering Different Network Slicing Constraints: Effect of Slice Monetary Cost Parameter on Handover Decision}

% Use \titlerunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\titlerunning{A Fuzzy-based system for Handover}

\author{Phudit Ampririt, Shunya Higashi, Ermioni Qafzezi, Makoto Ikeda, Keita Matsuo, Leonard Barolli}

% Use \authorrunning{Short Title} for an abbreviated version of
% your contribution title if the original one is too long
\authorrunning{P. Ampririt, S. Higashi, E. Qafzezi, M. Ikeda, K. Matsuo and L. Barolli}

\institute{
	Shunya Higashi
	\at Graduate School of Engineering, Fukuoka Institute of Technology,\\
	3-30-1 Wajiro-Higashi, Higashi-Ku, Fukuoka 811-0295, Japan,\\ 
	\email{mgm23108@bene.fit.ac.jp}
	\and 
	Phudit Ampririt, Ermioni Qafzezi, Makoto Ikeda, Keita Matsuo, Leonard Barolli 
	\at Department of Information and Communication Engineering, Fukuoka Institute of Technology,\\
	3-30-1 Wajiro-Higashi, Higashi-Ku, Fukuoka 811-0295, Japan,\\ 
	\email{ampririt@bene.fit.ac.jp, qafzezi@bene.fit.ac.jp, makoto.ikd@acm.org, kt-matsuo@fit.ac.jp, barolli@fit.ac.jp}
	}
...
%Mobility management is a crucial function in 5G/B5G networks, as it enables seamless access to wireless networks and mobile services, ensuring uninterrupted connectivity for users as they move. 
