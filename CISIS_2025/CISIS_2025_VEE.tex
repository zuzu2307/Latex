...
\svgpath{{./figure/}} %path to your svg files
\usepackage{amsmath}
...
%     \input{figure/ex1_result.pdf_tex}%imagine Avation
% 	\caption{Participants' accuracy in identifying different vibration cycle rates.}\label{fig:ex1_results}
% \end{figure}
\begin{figure}\centering
	\includegraphics[width=0.8\textwidth]{figure/ex1_result.png}%imagine Avation
	% \includesvg[width=0.6\columnwidth](ex1_result.svg)%imagine Avation
	\caption{Participants' accuracy in identifying different vibration cycle rates.}\label{fig:ex1_results}
\end{figure}
...
\begin{figure}\centering
	\includegraphics[width=0.8\textwidth]{figure/ex2_result.png}%imagine Avation
...
\begin{figure}\centering
	\includegraphics[width=0.8\textwidth]{figure/quetion_result.png}%imagine Avation
