...
\thispagestyle{empty}
\begin{center}
    \vspace*{1cm} % Adjust vertical spacing from top of page as needed

    {\Large \textbf{Development of a Wearable Haptic Feedback Device for Enhancing Immersion in Virtual Reality}} \\ % Your paper title
    \vspace{1.5cm} % Space between title and author
    {Computer Science \& Engineering} \\ % Your affiliation, if any, similar to template
    {Korntawat Witchuvanit} \\ % Your author name

    \vspace*{2cm} % Space between date and the 'Abstract' heading
\end{center}

% --- Abstract Section ---
\begin{center}
    \textbf{Abstract} % Centered and bolded "Abstract" heading
\end{center}
\vspace{0.5cm} % Add some space between the heading and the text
...
\vspace{5mm} % Adds vertical space before the keywords

\textbf{Keyword}: Human computer interaction (HCI), Texture Perception, Haptic devices

\vspace{2cm} % Space between author/affiliation and date
\begin{center}
      {July 23, 2025} % The date
\end{center}
% \clearpage
...
\begin{center}
    \vspace*{1cm} % Adjust vertical spacing from top of page as needed
    \begin{CJK*}{UTF8}{min}
      {\Large \textbf{仮想世界における没入感を高めるための装着型触力覚装置の開発}} \\ % Your paper title
      \vspace{1.5cm} % Space between title and author
      {情報工学専攻} \\ % Your affiliation, if any, similar to template
      {ウィチューヴァニット　コーンタワット} \\ % Your author name
      {\CJKfamily{mincho}}
    \end{CJK*}
    \vspace*{2cm} % Space between date and the 'Abstract' heading
...
% --- Abstract Section ---
\begin{center}
    \textbf{要旨} % Centered and bolded "Abstract" heading
\end{center}
\vspace{0.5cm} % Add some space between the heading and the text
